  ...
  return (
    <main className="main-content">
      ...
      <div className="middle-describes">
        <h2>대여사업이 뭔가요</h2>
        <h4>
          컴퓨터학부 학우분들의 보다 나은 생활을 위해
          <br />
          컴퓨터학부의 학생회비 납부자를 대상으로
          <br />
          물품 대여 사업을 진행하고 있습니다
        </h4>
      </div>
      ...
      <div className="return-info-section">
        <div className="return-info-content">
          ...
          <h3 className="right">
            <span className="highlight">언제까지 반납해야</span> 해요?
          </h3>
          <br />
          <br />
          <h3 className="left">
            당일로부터{' '}
            <span style={{ color: '#AA0000', fontWeight: 'bold' }}>
              3일 이내
            </span>
            에
          </h3>
          <h3 className="left">반납하면 됩니다</h3>
          <h4>주말 및 공휴일이 포함된 경우 해당 날짜들을 제외한 3일입니다.</h4>
          <br />
          <h4>기간을 넘길 시 경고 1회가 누적되며</h4>
          <h4>
            <span style={{ color: '#AA0000', fontWeight: 'bold' }}>
              경고 3회 누적 시 이용이 제한될 수 있습니다.
            </span>
          </h4>
        </div>
      </div>
      <div className="bottom-ask">
        <h4 style={{ color: '#3278F9', fontWeight: 'bold' }}>
          더 궁금하거나 요청사항이 있으신가요?
        </h4>
