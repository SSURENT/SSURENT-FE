...
export default function SendSmsCode() {
  ...
  const { handleSendSmsCode, isSendSmsCodeLoading, isSendSmsCodePWError } =
    useSendSmsCode();

  if (isSendSmsCodeLoading) {
    return (
      ...
      <div className="border border-gray-200 rounded-lg p-8 w-[400px] shadow-sm">
        ...
        <div className="flex justify-center">
          <button
            ...
            onClick={() => handleSendSmsCode(inputStudentNum, inputPhoneNum)}
          >
            변경 SMS 전송
          </button>
        </div>
